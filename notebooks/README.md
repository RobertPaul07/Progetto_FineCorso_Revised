...
**Autore:** ROBERT AMARIEI
**Corso:** PROGRAMMAZIONE E DATA ANALISI CON PYTHON
**Anno:** 2026
...
- **conda** — ambiente di sviluppo riproducibile
...
# 2. Creare l'ambiente conda dal file environment.yml
conda env create -f environment.yml

# 3. Attivare l'ambiente
conda activate esame-liceo-virgilio

# 4. Lanciare Jupyter
jupyter lab
```

A quel punto basta aprire i notebook nella cartella `notebooks/` ed eseguirli in ordine (00 → 01 → 02 → 03). Tutti i seed casuali sono fissati, quindi gli output sono **deterministici e riproducibili** identici a quelli mostrati nei notebook consegnati.
